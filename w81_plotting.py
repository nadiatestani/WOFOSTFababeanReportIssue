...
def plot_w81_soil_variables(df_output, Thickness):
    ...
    axs[0,0].set_ylabel('kg NH4+/ha', fontsize=20)
    axs[1,0].set_ylabel('kg NO3-/ha', fontsize = 20)
